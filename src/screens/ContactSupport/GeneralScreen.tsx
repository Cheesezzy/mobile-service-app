    ...
    <>
      ...
      <View style={[{ padding: 24, flex: 1 }, {
        ...
        <View style={[styles.container, {
          ...
          <Text style={[{ padding: 10, fontFamily: "PrimaryRegular", fontSize: 12, fontWeight: "400", lineHeight: 20 }, {
            color
          }]}>
            {info}
          </Text>
          ...
          <Text>
            {feedback ? (
              <View style={{ display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
                ...
                <Text style={[{ color }, { width: "90%", height: 50, fontSize: 15, fontWeight: "400" }]}>
                  {feedback}
                </Text>
              </View>
            ) : null
